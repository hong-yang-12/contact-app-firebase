...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <form
        onSubmit={login}
        className="w-[700px] flex flex-col items-center shadow-xl gap-10 rounded"
      >
        <div className="flex justify-evenly">
          ...
          <div className="flex flex-col justify-evenly items-center bg-button gap-5 p-7 rounded">
            <div>
            ...
            <img
              className=" w-80 "
              src="img\florid-remote-workflow.gif"
              alt=""
            />
          </div>
        </div>
